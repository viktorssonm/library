...
{
public:
    Book(std::string isbn, std::string title, std::string author, std::string copyright_date) : ISBN_(verifyISBN(isbn)), title_(title), author_(author), copyright_date_(copyright_date), isCheckedOut_(false){};
    std::string getISBN() const { return ISBN_; };
    std::string getTitle() const { return title_; };
    std::string getAuthor() const { return author_; };
    std::string getCopyright_date() const { return copyright_date_; };
    void checkInBook();
    void checkOutBook();
